...
complete -c vde-worktree -n "__fish_vw_needs_command" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_needs_command" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_needs_command" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_needs_command" -l full-path -d 'Show absolute paths in human list output'
complete -c vde-worktree -n "__fish_vw_needs_command" -l allow-unsafe -d 'Acknowledge explicitly requested unsafe operations'
complete -c vde-worktree -n "__fish_vw_needs_command" -l strict-post-hooks -d 'Return an error if a post-hook fails; retain the completed operation result'
...
complete -c vde-worktree -n "__fish_vw_needs_command" -f -a "check" -d 'Inspect a lifecycle mutation supplied after -- without applying it'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand init" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand init" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand init" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand init" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand list" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand list" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand list" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand list" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand status" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand status" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand status" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand status" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand path" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand path" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand path" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand path" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand switch" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand switch" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand switch" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand switch" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand new" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand new" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand new" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand new" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand mv" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand mv" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand mv" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand mv" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand del" -l fzf-arg -d 'Append one fzf argument; use --fzf-arg=VALUE for values beginning with a dash' -r
complete -c vde-worktree -n "__fish_vw_using_subcommand del" -l force -d 'Enable every deletion override; non-interactive use requires --allow-unsafe'
complete -c vde-worktree -n "__fish_vw_using_subcommand del" -l force-dirty -d 'Allow discarding dirty worktree files; non-interactive use requires --allow-unsafe'
complete -c vde-worktree -n "__fish_vw_using_subcommand del" -l allow-unpushed -d 'Allow commits ahead of upstream or unknown upstream state; non-interactive use requires --allow-unsafe'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand del" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand del" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand del" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand del" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand gone" -l fzf-arg -d 'Append one fzf argument; use --fzf-arg=VALUE for values beginning with a dash' -r
...
complete -c vde-worktree -n "__fish_vw_using_subcommand gone" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand gone" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand gone" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand gone" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand adopt" -l fzf-arg -d 'Append one fzf argument; use --fzf-arg=VALUE for values beginning with a dash' -r
...
complete -c vde-worktree -n "__fish_vw_using_subcommand adopt" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand adopt" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand adopt" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand adopt" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand get" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand get" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand get" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand get" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand extract" -l fzf-arg -d 'Append one fzf argument; use --fzf-arg=VALUE for values beginning with a dash' -r
...
complete -c vde-worktree -n "__fish_vw_using_subcommand extract" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand extract" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand extract" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand extract" -l full-path -d 'Show absolute paths in human list output'
complete -c vde-worktree -n "__fish_vw_using_subcommand extract" -l allow-unsafe -d 'Acknowledge explicitly requested unsafe operations'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand absorb" -l fzf-arg -d 'Append one fzf argument; use --fzf-arg=VALUE for values beginning with a dash' -r
...
complete -c vde-worktree -n "__fish_vw_using_subcommand absorb" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand absorb" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand absorb" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand absorb" -l full-path -d 'Show absolute paths in human list output'
complete -c vde-worktree -n "__fish_vw_using_subcommand absorb" -l allow-unsafe -d 'Acknowledge explicitly requested unsafe operations'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand unabsorb" -l fzf-arg -d 'Append one fzf argument; use --fzf-arg=VALUE for values beginning with a dash' -r
...
complete -c vde-worktree -n "__fish_vw_using_subcommand unabsorb" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand unabsorb" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand unabsorb" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand unabsorb" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand use" -l fzf-arg -d 'Append one fzf argument; use --fzf-arg=VALUE for values beginning with a dash' -r
...
complete -c vde-worktree -n "__fish_vw_using_subcommand use" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand use" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand use" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand use" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand exec" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand exec" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand exec" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand exec" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand invoke" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand invoke" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand invoke" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand invoke" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand copy" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand copy" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand copy" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand copy" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand link" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand link" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand link" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand link" -l full-path -d 'Show absolute paths in human list output'
complete -c vde-worktree -n "__fish_vw_using_subcommand link" -l allow-unsafe -d 'Acknowledge explicitly requested unsafe operations'
complete -c vde-worktree -n "__fish_vw_using_subcommand link" -l strict-post-hooks -d 'Return an error if a post-hook fails; retain the completed operation result'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand lock" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand lock" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand lock" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand lock" -l full-path -d 'Show absolute paths in human list output'
complete -c vde-worktree -n "__fish_vw_using_subcommand lock" -l allow-unsafe -d 'Acknowledge explicitly requested unsafe operations'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand unlock" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand unlock" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand unlock" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand unlock" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand cd" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand cd" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand cd" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand cd" -l full-path -d 'Show absolute paths in human list output'
complete -c vde-worktree -n "__fish_vw_using_subcommand cd" -l allow-unsafe -d 'Acknowledge explicitly requested unsafe operations'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand completion" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand completion" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand completion" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand completion" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand describe" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand describe" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand describe" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand describe" -l full-path -d 'Show absolute paths in human list output'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand context" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand doctor" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -s C -l directory -d 'Resolve repository, config, hooks and relative paths from this directory' -r -F
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -l worktree -d 'Select a registered worktree by path for status, path, exec, copy or link' -r -F
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -l hook-timeout-ms -d 'Maximum time per hook in milliseconds (default: hooks.timeoutMs, 30000)' -r
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -l lock-timeout-ms -d 'Maximum wait for the repository mutation lock in milliseconds (default: locks.timeoutMs, 15000)' -r
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -l prompt -d 'Override the interactive cd picker prompt' -r
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -l fzf-arg -d 'Append one fzf argument; use --fzf-arg=VALUE for values beginning with a dash' -r
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -l json -d 'Emit one JSON schema 3 object on stdout; diagnostics remain available as structured warnings'
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -l dry-run -d 'Inspect a lifecycle mutation without hooks, staging, locks, metadata writes or recovery'
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -l verbose -d 'Show resolved context and result diagnostics on stderr; repeat to include configuration'
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -s v -l version -d 'Print the version'
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -l hooks -d 'Enable automatic command hooks'
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -l no-hooks -d 'Disable automatic hooks; requires --allow-unsafe'
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -l gh -d 'Enable GitHub pull request lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -l no-gh -d 'Disable GitHub lookup and network requests made by that lookup'
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -l full-path -d 'Show absolute paths in human list output'
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -l allow-unsafe -d 'Acknowledge explicitly requested unsafe operations'
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -l strict-post-hooks -d 'Return an error if a post-hook fails; retain the completed operation result'
complete -c vde-worktree -n "__fish_vw_using_subcommand check" -s h -l help -d 'Print help'
...
complete -c vde-worktree -n "__fish_vw_using_subcommand help; and not __fish_seen_subcommand_from init list status path switch new mv del gone adopt get extract absorb unabsorb use exec invoke copy link lock unlock cd completion describe context doctor check help" -f -a "use" -d 'Check out a branch in the primary worktree'
complete -c vde-worktree -n "__fish_vw_using_subcommand help; and not __fish_seen_subcommand_from init list status path switch new mv del gone adopt get extract absorb unabsorb use exec invoke copy link lock unlock cd completion describe context doctor check help" -f -a "exec" -d 'Run an argv command in a branch worktree'
complete -c vde-worktree -n "__fish_vw_using_subcommand help; and not __fish_seen_subcommand_from init list status path switch new mv del gone adopt get extract absorb unabsorb use exec invoke copy link lock unlock cd completion describe context doctor check help" -f -a "invoke" -d 'Invoke a named hook'
complete -c vde-worktree -n "__fish_vw_using_subcommand help; and not __fish_seen_subcommand_from init list status path switch new mv del gone adopt get extract absorb unabsorb use exec invoke copy link lock unlock cd completion describe context doctor check help" -f -a "copy" -d 'Copy repository-relative paths into the target worktree'
complete -c vde-worktree -n "__fish_vw_using_subcommand help; and not __fish_seen_subcommand_from init list status path switch new mv del gone adopt get extract absorb unabsorb use exec invoke copy link lock unlock cd completion describe context doctor check help" -f -a "link" -d 'Link repository-relative paths into the target worktree'
complete -c vde-worktree -n "__fish_vw_using_subcommand help; and not __fish_seen_subcommand_from init list status path switch new mv del gone adopt get extract absorb unabsorb use exec invoke copy link lock unlock cd completion describe context doctor check help" -f -a "lock" -d 'Protect a worktree with persistent lock metadata'
